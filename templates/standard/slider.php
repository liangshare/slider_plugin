...
?>
<div reasong-only="move-to-top" tabindex="0" class="cycloneslider cycloneslider-template-standard cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?>"
